...
import models.listados.ListaPedidosPendientes
import java.io.File
 ...
 */
class FicheroJsonPedidosPendientes: FicherosJson<ListaPedidosPendientes> {
    private var json = Json { prettyPrint=true }
    private var mutex = Mutex()

    override suspend fun writeFichero(path: String, item: ListaPedidosPendientes) {
